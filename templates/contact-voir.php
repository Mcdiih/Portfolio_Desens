...
<div class="container">
		<nav>
            <a href="contact-ajout.php">Poster un message</a>
		</nav>
</div>
...
<div class="container">		
    ...
    if(!empty($_POST)){
        ...
        elseif(mb_strlen($nom) <= 1){
            $formIsValid = false;
            $errors[] = "VOTRE NOM est court, très court, trop court... Merci de le rallonger !";
        }    
        ...
        if(empty($message)){
            $formIsValid = false;
            $errors[] = "Merci d'écrire quelque chose dans le champs \"VOTRE MESSAGE\" !!";
        }
